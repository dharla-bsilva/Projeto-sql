...
--Aumente em 12% o valor dos produtos cujo nomes iniciem com a letra 'F':
update produtos set quantidade = quantidade *1.12  where nome like 'f%';
...
--Apricar um desconto de 50%(*0.5) em todos os produtos que as unidades de estoque sejam maiores que 300:
...
--Exibir todos os produtos que se iniciem com o nome 'MO' e tenham como tipos as letras 'MA':
